...
export const defaultChallenges: CommunityChallenge[] = [
  {
    ...
    description: 'Acumula al menos 40 km de carrera, cinta o cardio exterior esta semana.',
    category: 'distance',
    goalTarget: 40,
    currentProgress: 0,
    unit: 'km',
    ...
    daysRemaining: 6,
    rewardXp: 800,
    rewardBadge: 'badge_cardio_40k',
    joined: false,
    leaderboardTop: [
      { userId: 'u_c1', name: 'Mateo Runner', avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=100', score: 32.8 },
      { userId: 'u_c2', name: 'Valeria Iron', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100', score: 28.4 },
    ],
  },
  {
    id: 'ch_weekly_volume_titan_100k',
    title: 'Levantamiento de Titán Semanal (100.000 kg)',
    description: 'Levanta más de 100.000 kg acumulados entre todas tus sesiones esta semana.',
    category: 'volume',
    goalTarget: 100000,
    currentProgress: 0,
    unit: 'kg',
    ...
    joined: false,
    leaderboardTop: [
      { userId: 'u_1', name: 'Valeria Iron', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100', score: 84500 },
      { userId: 'u_2', name: 'Diego Beast', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100', score: 76200 },
    ],
  },
  {
    id: 'ch_weekly_consistency_5days',
    title: 'Consistencia de Hierro (5 Días)',
    description: 'Entrena en al menos 5 días diferentes de esta semana antes del domingo.',
    category: 'workouts',
    goalTarget: 5,
    currentProgress: 0,
    unit: 'días',
    ...
    daysRemaining: 4,
    rewardXp: 600,
    rewardBadge: 'badge_consistency_5',
    joined: false,
    leaderboardTop: [
  ...
  },
  {
    ...
    description: 'Quema 5.000 calorías acumuladas durante tus entrenamientos activos esta semana.',
    category: 'calories',
    goalTarget: 5000,
    currentProgress: 0,
    unit: 'kcal',
    ...
    daysRemaining: 6,
    rewardXp: 800,
    rewardBadge: 'badge_burner_5k',
    joined: false,
    leaderboardTop: [
      { userId: 'u_5', name: 'Sofia Lift', avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100', score: 4200 },
      { userId: 'u_6', name: 'Mateo Runner', avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=100', score: 3850 },
    ],
  },
];
