      ...
      <div className="bg-[#121214] border border-cyan-500/30 rounded-3xl max-w-lg w-full shadow-2xl flex flex-col max-h-[92vh] animate-in zoom-in-95 overflow-hidden">
        ...
        <div className="p-4 sm:p-5 space-y-4 overflow-y-auto flex-1 no-scrollbar">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[10px] font-mono text-neutral-400 pt-0.5">Títulos por Nivel y Logros:</p>
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected ? (
                      ...
                      <span className="text-[10px] text-neutral-300">Desbloqueado</span>
                    ) : (
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected ? (
                      ...
                      <span className="text-[10px] text-neutral-500">🔒 Logro Bloqueado</span>
                    )}
                  </button>
                );
              })}
